...
fname = "../3_PREP_ANALYSES/exp1_data_with_norms_reordered_20221029.csv"
fname_accs1 = "../expt1_subject_splits/exp1_accs1_20221029.csv"
fname_accs2 = "../expt1_subject_splits/exp1_accs2_20221029.csv"
...
if __name__ == '__main__':
	...
	if posthoc_stats:
		...
		# Test ideal observer model against topic variability model
		posthoc_ttest(result_dir=RESULTDIR,
						  save_subfolder1='2_monogamous_meanings',
						  save_subfolder2='2_monogamous_meanings',
						  model1='baseline_human_no_nans_topic',
						  model2='topicvar',
						  datetag='20221029',
						  save=save)
